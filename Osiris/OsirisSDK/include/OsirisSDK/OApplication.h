...
public:
	 ...
	 */
	OApplication(const char* aTitle, int aArgc, char **aArgv, GraphicsAPI aGraphicsApi = GraphicsAPI::OpenGL,
	...
	*/
	...
	/**
	 ...
	 @param aSimulationStep The desired simulation step in microseconds.
	 */
	void setSimulationStep(int aSimulationStep);
	 ...
	 */
	void addEventRecipient(OEventType aEventType, OObject* aRecipient);
	...
	/**
	 ...
	 @param recipient Object that will receive the events.
	 */
	void removeEventRecipient(OEventType eventType, OObject* recipient);
...
protected:
	...
	*/
	 ...
	 */
	virtual void update(const OTimeIndex& aTimeIndex, int aStep_us) = 0;
